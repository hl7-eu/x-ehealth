...
// ---- Identifiers
Alias : $pat-id-cineca = http://hl7.eu/fhir/ig/xeh/sid/pat-id-cineca // Temporary assigned
Alias : $pat-id-hulafe = http://hl7.eu/fhir/ig/xeh/sid/pat-id-hulafe
Alias : $pat-id-vulsk = http://hl7.eu/fhir/ig/xeh/sid/pat-id-vulsk
Alias : $pat-id-mainz = http://hl7.eu/fhir/ig/xeh/sid/pat-id-mainz
Alias : $org-id-mainz = http://hl7.eu/fhir/ig/xeh/sid/org-id-mainz

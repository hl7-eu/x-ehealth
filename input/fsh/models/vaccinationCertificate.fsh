...
Description: "Logical Model representing the EU Digital COVID Certificate"
Title: "EU Digital COVID Certificate"
Usage: #definition

* publisher = "X-eHealth project"
* status = #draft
* url = "http://hl7.eu/fhir/ig/xeh/StructureDefinition/vaccinationCertificate"
...
* differential.element[1].mapping[0].map = "Composition.conformsTo('http://hl7.eu/fhir/ig/xeh/StructureDefinition/Composition-svc').subject"

* differential.element[1].mapping[1].identity = "fhir"
* differential.element[1].mapping[1].map = "Immunization.conformsTo('http://hl7.eu/fhir/ig/xeh/StructureDefinition/Immunization-svc').patient"
...
* differential.element[6].mapping[0].map = "Immunization.conformsTo('http://hl7.eu/fhir/ig/xeh/StructureDefinition/Immunization-svc')"

* differential.element[7].mapping[0].identity = "fhir"
* differential.element[7].mapping[0].map = "Immunization.conformsTo('http://hl7.eu/fhir/ig/xeh/StructureDefinition/Immunization-svc').protocolApplied.targetDisease"

* differential.element[8].mapping[0].identity = "fhir"
* differential.element[8].mapping[0].map = "Immunization.conformsTo('http://hl7.eu/fhir/ig/xeh/StructureDefinition/Immunization-svc').vaccineCode"

* differential.element[9].mapping[0].identity = "fhir"
* differential.element[9].mapping[0].map = "Immunization.conformsTo('http://hl7.eu/fhir/ig/xeh/StructureDefinition/Immunization-svc').vaccineCode.text"

* differential.element[10].mapping[0].identity = "fhir"
* differential.element[10].mapping[0].map = "Immunization.conformsTo('http://hl7.eu/fhir/ig/xeh/StructureDefinition/Immunization-svc').manufacturer"

* differential.element[11].mapping[0].identity = "fhir"
* differential.element[11].mapping[0].map = "Immunization.conformsTo('http://hl7.eu/fhir/ig/xeh/StructureDefinition/Immunization-svc').protocolApplied.doseNumber[x], Immunization.conformsTo('http://hl7.eu/fhir/ig/xeh/StructureDefinition/Immunization-svc').protocolApplied.seriesDoses[x]"

* differential.element[12].mapping[0].identity = "fhir"
* differential.element[12].mapping[0].map = "Immunization.conformsTo('http://hl7.eu/fhir/ig/xeh/StructureDefinition/Immunization-svc').lotNumber"

* differential.element[13].mapping[0].identity = "fhir"
* differential.element[13].mapping[0].map = "Immunization.conformsTo('http://hl7.eu/fhir/ig/xeh/StructureDefinition/Immunization-svc').occurrenceDateTime"

* differential.element[14].mapping[0].identity = "fhir"
* differential.element[14].mapping[0].map = "Immunization.conformsTo('http://hl7.eu/fhir/ig/xeh/StructureDefinition/Immunization-svc').performer, Immunization.conformsTo('http://hl7.eu/fhir/ig/xeh/StructureDefinition/Immunization-svc').location"

* differential.element[15].mapping[0].identity = "fhir"
* differential.element[15].mapping[0].map = "Immunization.conformsTo('http://hl7.eu/fhir/ig/xeh/StructureDefinition/Immunization-svc').performer"

* differential.element[16].mapping[0].identity = "fhir"
* differential.element[16].mapping[0].map = "Immunization.conformsTo('http://hl7.eu/fhir/ig/xeh/StructureDefinition/Immunization-svc').location.address.country"
...
* differential.element[19].mapping[0].map = "Composition.conformsTo('http://hl7.eu/fhir/ig/xeh/StructureDefinition/Composition-svc').attester.party"

* differential.element[20].mapping[0].identity = "fhir"
* differential.element[20].mapping[0].map = "Build.conformsTo('http://hl7.eu/fhir/ig/xeh/StructureDefinition/Build-svc').identifier"

* differential.element[20].mapping[1].identity = "fhir"
* differential.element[20].mapping[1].map = "Composition.conformsTo('http://hl7.eu/fhir/ig/xeh/StructureDefinition/Composition-svc').identifier"

* differential.element[21].mapping[0].identity = "fhir"
* differential.element[21].mapping[0].map = "Composition.attester.time, Build.conformsTo('http://hl7.eu/fhir/ig/xeh/StructureDefinition/Build-svc').identifier.period.start"

* differential.element[22].mapping[0].identity = "fhir"
* differential.element[22].mapping[0].map = "Build.conformsTo('http://hl7.eu/fhir/ig/xeh/StructureDefinition/Build-svc').identifier.period.end"
// 
// === INVARIANTS === 
//  

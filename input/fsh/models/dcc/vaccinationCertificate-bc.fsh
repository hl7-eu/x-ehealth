...
Description: "Logical Model representing the EU Digital COVID Certificate for Border Control"
Title: "EU Digital COVID Certificate - Border Control"
Usage: #definition
...
* baseDefinition = "http://hl7.eu/fhir/ig/xeh/StructureDefinition/vaccinationCertificate"

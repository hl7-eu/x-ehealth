Instance: BundleRareCancer-01
InstanceOf: Bundle
Title: "Bundle GIST Structured Text"
Description: "GIST Structured Text"
Usage: #example
* identifier.system = "http://example.org"
* identifier.value = "V1CZ454557891308174803488707671418"
* type = #document
* timestamp = "2020-12-27T14:30:00+01:00"
* entry[+].fullUrl = "urn:uuid:30551ce1-5a28-4356-b684-1e639094ad4e"
* entry[=].resource = Inline-composition-01-1
* entry[+].fullUrl = "urn:uuid:2b90dd2b-2dab-4c75-9bb9-a355e07401e9"
* entry[=].resource = Inline-Patient-01-2
* entry[+].fullUrl = "urn:uuid:45a5c5b1-4ec1-4d60-b4b2-ff5a84a41fd7"
* entry[=].resource = Inline-Organization-01-4


Instance: Inline-composition-01-1
InstanceOf: Composition
Usage: #inline

* id = "30551ce1-5a28-4356-b684-1e639094ad4e"
...
Instance: Inline-Organization-01-4

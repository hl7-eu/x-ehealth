...
Parent:   Observation
Id:       Observation-bld-abo-rh-eu-xeh
Title:    "Observation: Blood type/RH"
Description: "This profile defines how to represent Blood type/RH  before or after the SCT in HL7 FHIR for the purpose of the X-eHealth project."
//-------------------------------------------------------------------------------------------
...
* partOf 1.. 
* partOf only Reference (ProcedureSctXeh) 
 


//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
Profile:  ConditionGvhdXeh
Parent:   Condition
Id:       Condition-gvhd-eu-xeh
Title:    "Condition: GvHD"
Description: "This profile defines how to represent Graft versus host disease (GvHD) in HL7 FHIR for the purpose of the X-eHealth project."
//-------------------------------------------------------------------------------------------
...
* extension[conditionDueTo].valueReference only Reference(ProcedureSctXeh)
...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
Profile:  BiologicallyDerivedProductSctXeh
Parent:   BiologicallyDerivedProduct	 
Id:       BiologicallyDerivedProduct-sct-eu-xeh
Title:    "BiologicallyDerivedProduct: Stem Cell"
Description: "This profile defines how to represent Stem Cell in FHIR for describing a Stem Cell Transplantation data required by the X-eHealth algorithm to generate the care plan."
//-------------------------------------------------------------------------------------------
...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
Profile:  ProcedureSctProphylaxisXeh
Parent:   Procedure 
Id:       Procedure-sct-prophylaxis-eu-xeh
Title:    "Procedure: SCT Prophylaxis"
Description: "This profile defines how to represent GVHD prophylaxis, conditioning regimen Procedures in FHIR for supporting Stem Cell Transplantation data, as required by the X-eHealth algorithm to generate the care plan."
//-------------------------------------------------------------------------------------------
...
* reasonReference only Reference(ConditionPrimaryCancerXeh or ProcedureSctXeh)


//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
Profile:  ProcedureSctXeh
Parent:   Procedure 
Id:       Procedure-sct-eu-xeh
Title:    "Procedure: Stem Cell Transplantation"
Description: "This profile defines how to represent Procedures in FHIR for describing a set of Stem Cell Transplantation data required by the X-eHealth algorithm to generate the care plan."
//-------------------------------------------------------------------------------------------

* extension contains ProcedureUsedReference named usedReference 0..1
* extension[usedReference].valueReference only Reference(BiologicallyDerivedProductSctXeh)
